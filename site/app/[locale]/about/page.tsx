...
const lessons = [
  ...
  },
  {
    ...
    body: "Не плівкою з тисненням «під крокодила». Справжня шкіра темніє, набуває патини, стає цікавішою через рік. Плівка просто облазить.",
  },
  {
    ...
    <div>
      ...
      <section className="wrap-narrow" style={{ paddingBlock: "var(--s-9)" }}>
        ...
        <Reveal delay={0.2} style={{ marginTop: "var(--s-7)" }}>
          ...
          <p style={{ color: "var(--text-body)", marginTop: "var(--s-4)" }}>
            Наша гарантія коротка й чесна: до першого покуру, за відсутності механічних заводських поломок. Ми не
